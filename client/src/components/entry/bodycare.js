...
const BodyCareForm = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await axios.post("http://localhost:8000/entry/create-bodycare", data,
        {headers:{
      ...
      toast.success("Body care product added successfully!");
      reset();
      setUploadedImages([]);
    } catch (error) {
      ...
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-xl overflow-hidden md:max-w-2xl">
        <div className="md:flex">
          <div className="p-8 w-full">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Body Care Product Entry</h2>
